...
\input{Chapters/1_introduction.tex} \pagenumbering{arabic}
\newpage

\input{Chapters/2_workflow.tex}
\newpage

\input{Chapters/3_function.tex}
\newpage

\input{Chapters/4_fsa_design.tex}
\newpage

\input{Chapters/5_git.tex}
\newpage

\input{Chapters/6_extend.tex}
\newpage

\input{Chapters/7_api.tex}
\newpage
