...
public class JavaCraft28_08_2023{
  ...
  private static final int CRAFT_GOLDEN_INGOT = 103;
  private static final int CRAFTED_WOODEN_PLANKS = 200;
  private static final int CRAFTED_STICK = 201;
  private static final int CRAFTED_IRON_INGOT = 202;
  private static final int CRAFTED_GOLDEN_INGOT = 203;
  ...
  public static void initGame(int worldWidth, int worldHeight) {
    JavaCraft28_08_2023.worldWidth = worldWidth;
    JavaCraft28_08_2023.worldHeight = worldHeight;
    JavaCraft28_08_2023.world = new int[worldWidth][worldHeight];
  ...
  public static void startGame() {
    ...
    while (true) {
      ...
      System.out.println(ANSI_CYAN
          + "Enter your action: 'WASD': Move, 'M': Mine, 'P': Place, 'C': Craft, 'I': Interact, 'Save': Save, 'Load': Load, 'Exit': Quit, 'Unlock': Unlock Secret Door, 'Open' : Enter Secret Door"
          + ANSI_RESET);
  ...
  public static void mineBlock() {
    ...
    if (blockType != AIR && blockType != BOOM )  {
      inventory.add(blockType);
      world[playerX][playerY] = AIR;
      System.out.println("Mined " + getBlockName(blockType) + ".");
    } else if (blockType == BOOM){
        System.out.println("Oh no , this is a BOMB");
  ...
  private static int getBlockTypeFromCraftedItem(int craftedItem) {  //SAME AS getCraftedItemFromBlockType 
    switch (craftedItem) {
  ...
  public static void displayCraftingRecipes() {
    ...
    System.out.println("4. Craft Golden Ingot: 2 Gold Ore");
  }
  ...
  public static void craftGoldenIngot(){
    ...
    else System.out.println("Insufficient resources to craft Golden Ingot.");
  }
  ...
  public static void displayLegend() {
    ...
    System.out.println(ANSI_PURPLE + "\u0001\u0001- Bomb block");
