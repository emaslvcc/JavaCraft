...
public static int count = 0;
    ...
    public static boolean isAchievement3CriteriaMet() {
        if( count >= 3 && count4 == 0){return true;} // Replace 'count' with your actual count variable
        else{return false;}

    }

    public static void achievementComplete1() {
        System.out.println("Achievement 1 Complete");
    }

    public static void achievementComplete2() {
        System.out.println("Achievement 2 Complete");
    }

    public static void achievementComplete3() {
        System.out.println("Achievement 3 Complete");}
    ...
    public static void displayAchievements(){
        ...
        System.out.println(Achievements[0] +"\n" + Achievements[1] +"\n" + Achievements[2]);
