...
public class JavaCraft {
  ...
  private static final int CRAFTED_GOLD_INGOT = 103;
  private static final int CRAFTED_DIAMOND_INGOT = 104;
  private static final int CRAFTED_WOODEN_PLANKS = 200;
  private static final int CRAFTED_STICK = 201;
  private static final int CRAFTED_IRON_INGOT = 202;
  private static final int CRAFTED_GOLDEN_HELMET = 203;
  private static final int CRAFTED_DIAMOND_SWORD = 204;
  ...
  public static void displayCraftingRecipes() {
    ...
    System.out.println("4.Craft Gold Helmet: 3 Sticks and 4 Gold");
    System.out.println("5.Craft Diamond Sword: 3 Sticks and 5 Diamonds");
  }
  ...
  public static void craftGoldenHelmet(){
       if (inventoryContains(CRAFTED_STICK, 3) && inventoryContains(CRAFTED_GOLD_INGOT, 4)){
        removeItemsFromInventory(CRAFTED_STICK, 3);
        removeItemsFromInventory(CRAFTED_GOLD_INGOT, 4);
        addCraftedItem(CRAFTED_GOLDEN_HELMET);
        System.out.println("Crafted Golden Helmet.");
        }
      else {
        System.out.println("Insufficient resources to craft Golden Helmet.");
      }
    }

  public static void craftDiamondSword(){
       if (inventoryContains(CRAFTED_STICK, 3) && inventoryContains(CRAFTED_DIAMOND_INGOT, 5)){
        removeItemsFromInventory(CRAFTED_STICK, 3);
        removeItemsFromInventory(CRAFTED_DIAMOND_INGOT, 5);
  ...
  public static void displayLegend() {
    ...
    //System.out.println(ANSI_YELLOW + "? - \u001B[33m\u001B[33m - Gold ore block" );
    //System.out.println(ANSI_PURPLE+ "? - \u001B[35m\u001B[35m - Diamond ore block" );
    ...
    public static void displayInventory() {
      ...
      if (inventory.isEmpty()) {
          ...
          int[] blockCounts = new int[10]; // Increase the size of blockCounts
  ...
  public static void getCountryAndQuoteFromServer() {
    try {
      URI uri = new URI("https://flag.ashish.nl/get_flag");
      URL url = uri.toURL();
      ...
      String payload = "{ \"group_number\": \"041\", \"group_name\": \"group41\", \"difficulty_level\": \"easy\" }";
