...
public class JavaCraft {
  ...
  private static final int VIBRANIUM = 6;
  ...
  private static final int CRAFT_VIBRANIUM_BLOCK =104;
...
private static char getBlockChar(int blockType) {
  ...
  public static void displayInventory() {
    ...
    if (inventory.isEmpty()) {
      ...
      // > logic for printing _STACKABLE_ items in inventory
    ...
    if (craftedItems == null || craftedItems.isEmpty()) {
      ...
      // Implement same logic for stackable crafted items, such as Diamond Block
