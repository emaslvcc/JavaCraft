...
public class JavaCraft {
    ...
    private static void generateEmptyWorld() {
        ...
        world[1][0] = whiteBlock;
        world[2][1] = whiteBlock;
        world[0][3] = whiteBlock;
        world[1][3] = whiteBlock;
        world[2][3] = whiteBlock;
        world[3][3] = whiteBlock;
        world[3][0] = whiteBlock;
        world[3][1] = whiteBlock;
        world[3][2] = whiteBlock;
        world[7][0] = whiteBlock;
        world[7][1] = whiteBlock;
        world[7][2] = whiteBlock;
        world[7][3] = whiteBlock;
        world[8][3] = whiteBlock;
        world[9][3] = whiteBlock;
        world[10][3] = whiteBlock;
        world[8][1] = whiteBlock;
        world[9][0] = whiteBlock;
        world[0][8] = whiteBlock;
        world[1][7] = whiteBlock;
        world[10][8] = whiteBlock;
        world[9][7] = whiteBlock;
        world[0][6] = whiteBlock;
        world[1][6] = whiteBlock;
        world[2][6] = whiteBlock;
        world[3][6] = whiteBlock;
        world[3][7] = whiteBlock;
        world[3][8] = whiteBlock;
        world[3][9] = whiteBlock;
        world[7][6] = whiteBlock;
        world[8][6] = whiteBlock;
        world[9][6] = whiteBlock;
        world[10][6] = whiteBlock;
        world[7][7] = whiteBlock;
        world[7][8] = whiteBlock;
        world[7][9] = whiteBlock;
        world[20][10] = whiteBlock;
        for (int y = 11; y < 14; y++){
            for (int x = 4; x < 7; x++){
    ...
    public static void mineBlock() {
        ...
        if (blockType != AIR) {
            ...
            if(getBlockName(blockType) != "Apple"){
                System.out.println("Mined " + getBlockName(blockType) + ".");
            }
            else{
                System.out.println("Collected an " + getBlockName(blockType) + ".");
            }
        } else {
    ...
    public static void displayCraftingRecipes() {
        ...
        System.out.println("4. Craft Golden Apple: 1 Apple, 4 Gold Ore");
    }
    ...
    public static void craftGoldenApple() {
        if (inventoryContains(APPLE, 1) && inventoryContains(GOLD_ORE, 4)) {
