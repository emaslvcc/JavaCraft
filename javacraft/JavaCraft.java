...
public class JavaCraft {
  ...
  private static final int CRAFT_DIAMOND_INGOT = 300;
  private static final int CRAFTED_WOODEN_PLANKS = 200;
  private static final int CRAFTED_STICK = 201;
  private static final int CRAFTED_IRON_INGOT = 202;
  private static final int CRAFTED_DIAMOND_INGOT = 301;
  ...
  private static String getBlockColor(int blockType) { //review this later
    switch (blockType) {
      case AIR:
        return "";
      case WOOD:
