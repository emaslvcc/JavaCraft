...
public class JavaCraft {
  ...
  private static final int CLAY = 6;
  
  private static final int WALL_BLOCK = 10;
  private static int NEW_WORLD_WIDTH = 51;
  private static int NEW_WORLD_HEIGHT = 33;
  ...
  private static final int CRAFTED_POT = 203;
  ...
  private static final String ANSI_WHITEFLAG = "\u001B[97m";
  ...
  public static void displayWorld() {
    ...
    for (int y = 0; y < worldHeight; y++) {
      if(inSecretArea)
        System.out.print(getBlockSymbol(world[1][y]).substring(0, 5) + "║" + ANSI_RESET);
      else
        System.out.print("║");
      for (int x = 0; x < worldWidth; x++) {
  ...
  public static void displayCraftingRecipes() {
    ...
    System.out.println("4. Craft Pot: 2 clay ");
  }
  ...
  public static void interactWithWorld() {
    ...
    switch (blockType) {
      ...
      case IRON_ORE:
        ...
        break;
      case SAND:
        System.out.println("You gather sand from the ground.");
        inventory.add(SAND);
        break;
      case CLAY:
        System.out.println("You gather clay from the ground.");
        inventory.add(CLAY);
        break; 
      case AIR:
  ...
  public static void displayLegend() {
    ...
    System.out.println(ANSI_YELLOW+ "\u2593 - Sand");
    System.out.println(ANSI_PURPLE+ "\u25CF - Clay");
  ...
  public static void displayInventory() {
    ...
    if (inventory.isEmpty()) {
      ...
      for (int blockType = 1; blockType < blockCounts.length; blockType++) {
        ...
        if (occurrences > 0) {
          System.out.println(ANSI_RED+ getBlockName(blockType) + " - " + occurrences);
        }
      }
    }
    ...
    if (craftedItems == null || craftedItems.isEmpty()) {
      ...
      for (int item : craftedItems) {
        System.out.println(getCraftedItemColor(item) + getCraftedItemName(item) + ANSI_RESET);
      }
      //System.out.println();
    }
    System.out.println();
