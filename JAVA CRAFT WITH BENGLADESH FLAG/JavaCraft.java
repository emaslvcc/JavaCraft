...
// i have changed this line you wrote hi
...
public class JavaCraft {
  ...
  private static void generateEmptyWorld() {
     ...
     * }
     * }
     * //pine tree thingy on the lebanon flag :3
     * //y < stripeHeight * 2
     * for (int x = (NEW_WORLD_WIDTH/2)-1; x < (NEW_WORLD_WIDTH/2)+2; x++){
     * for (int y = stripeHeight - 2; y <
     * (stripeHeight *2) + 2; y++){
     * world[x][y] = greenBlock;
     * 
     * }
     * }
     * 
     * //for (int y = (stripeHeight *2) + 1 )
     * 
     * // Fill the middle stripe with white blocks
     * for (int y = stripeHeight - 2; y < (stripeHeight * 2) + 2; y++) {
     * for (int x = 0; x < NEW_WORLD_WIDTH; x++) {
     * if (world[x][y] != greenBlock){
     ...
     * for (int y = (stripeHeight * 2) + 2; y < NEW_WORLD_HEIGHT; y++) {
     * for (int x = 0; x < NEW_WORLD_WIDTH; x++) {
     * world[x][y] = redBlock;
     * }
     * }
  ...
  public static void getCountryAndQuoteFromServer() {
    try {
      ...
      String payload = "{\n" +
          ...
          "}";
      // OutputStreamWriter basically converts the string to bytes so that other
      // things can understand it
