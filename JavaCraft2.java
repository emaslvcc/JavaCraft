...
public class JavaCraft2 {
  ...
  public static void initGame(int worldWidth, int worldHeight) {
    JavaCraft2.worldWidth = worldWidth;
    JavaCraft2.worldHeight = worldHeight;
    JavaCraft2.world = new int[worldWidth][worldHeight];
  ...
  public static void getCountryAndQuoteFromServer() {
    try {
      ...
      String payload =
        "{\"group_number\":\"Test-XX\",\"group_name\":\"GroupXX\",\"difficulty_level\":\"medium\"}";
