...
public class JavaCraft {
  private static final char APPLES ='*';
  ...
  private static final int COAL=5;// Benim ekledigim
  ...
  private static final int CRAFTED_TORCH=203;// Benim ekledigim
  ...
  private static final String PARLAK_KIRMIZI="\u001B[30m";//Benim ekledigim
  private static final String BLOCK_NUMBERS_INFO = "Block Numbers:\n" +
      ...
      "8 - Coal block\n"+// benim ekledigim
      "9 - Torch(Crafted Item)\n"+// benim ekledigim
      "10- Apple Candy(Crafted Item)\n"+
      "11- Apple\n";
  ...
  public static void displayCraftingRecipes() { // Display for the crafting recipes the player has (it is very limited maybe expand a little bit?)
    ...
    System.out.println("4. Craft Torch: 2 Coal");
    System.out.println("5. Craft Apple Candy: 1 Apple and 1 Stick");
  }
...
public static void removeItemsFromCraftedItems(int item, int count) {  //when an Item is used it needs to be removed from tghe player inventory
  ...
  public static void displayLegend() { // Legend from the items images, world border, and player symbol
    ...
    System.out.println(ANSI_YELLOW + APPLES+ "- Apple");
