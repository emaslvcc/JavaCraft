...
public class JavaCraft {
  ...
  private static final int CRAFT_STEEL = 103;
  private static final int CRAFTED_WOODEN_PLANKS = 200;
  private static final int CRAFTED_STICK = 201;
  private static final int CRAFTED_IRON_INGOT = 202;
  private static final int CRAFTED_STEEL = 203;
  private static final String ANSI_BROWN = "\u001B[90m";
  ...
  public static void craftSteel() {
    if (inventoryContains(COPPER, 2)){
      removeItemsFromInventory(COPPER, 2);
      addCraftedItem(CRAFTED_STEEL);
      System.out.println("Crafted Steel.");
    } else {
      System.out.println("Insufficient resources to craft Steel.");
    }
  }
  ...
  public static void interactWithWorld() {
    ...
    switch (blockType) {
      ...
      case GOLD:
        ...
        break;
      case COPPER:
        System.out.println("You mine copper from the ground.");
  ...
  public static void displayLegend() {
    ...
    System.out.println(ANSI_YELLOW + "\u00DF\u00DF- Gold block");
    System.out.println(ANSI_BROWN + "\u0025\u0025- Copper block");
  ...
  public static void getCountryAndQuoteFromServer() {
    try {
      ...
      String payload = " {\"group_number\": \"69\", \"group_name\": \"group69\",\"difficulty_level\": \"hard\"}";
